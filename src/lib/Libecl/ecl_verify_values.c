...
/**
 * @brief
 *	Function checks the job attributes "window_start"
 *	& "window_duration" and verifies their values
 *
 * @see
 *
 * @param[in]	batch_request	-	Batch Request Type
 ...
 */
int
verify_value_window_start_duration(int batch_request, int parent_object, int cmd,
	struct attropl *pattr, char **err_msg)
{
	int hh;
	int mm;
	int len = strlen(pattr->value);
