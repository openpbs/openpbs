...
pbs_authors()
{
	...
	printf("\t Copyright (C) 1994-2017 Altair Engineering, Inc.\n");
	...
	printf("\t PARTICULAR PURPOSE.  See the GNU Affero General Public License for more details.\n\n");
	printf("\t You should have received a copy of the GNU Affero General Public License along\n");
	printf("\t with this program.  If not, see <http://www.gnu.org/licenses/>.\n\n");
	printf("\t Commercial License Information:\n");
	printf("\t The PBS Pro software is licensed under the terms of the GNU Affero General\n");
	printf("\t Public License agreement (\"AGPL\"), except where a separate commercial license\n");
	printf("\t agreement for PBS Pro version 14 or later has been executed in writing with Altair.\n\n");
	printf("\t Altair’s dual-license business model allows companies, individuals, and\n");
	printf("\t organizations to create proprietary derivative works of PBS Pro and distribute\n");
	printf("\t them - whether embedded or bundled with other software - under a commercial\n");
