...
_pv1mod_insert_int_constants(PyObject *dict) {
	...
	INSERT_INT_CONSTANT("ND_DELETED", INUSE_DELETED);
	...
	INSERT_INT_CONSTANT("ND_NEEDS_HELLOSVR", INUSE_NEEDS_HELLOSVR);
	INSERT_INT_CONSTANT("ND_INIT", INUSE_INIT);
	...
	INSERT_INT_CONSTANT("ND_RESVEXCL", INUSE_RESVEXCL);
	INSERT_INT_CONSTANT("ND_OFFLINE_BY_MOM", INUSE_OFFLINE_BY_MOM);
	INSERT_INT_CONSTANT("ND_MARKEDDOWN", INUSE_MARKEDDOWN);
	INSERT_INT_CONSTANT("ND_NEED_ADDRS", INUSE_NEED_ADDRS);
	INSERT_INT_CONSTANT("ND_MAINTENANCE", INUSE_MAINTENANCE);
	INSERT_INT_CONSTANT("ND_NEED_CREDENTIALS", INUSE_NEED_CREDENTIALS);
	INSERT_INT_CONSTANT("ND_VNODE_AVAILABLE", VNODE_AVAILABLE);
	INSERT_INT_CONSTANT("ND_VNODE_UNAVAILABLE", VNODE_UNAVAILABLE);
