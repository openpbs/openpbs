...
_pv1mod_insert_int_constants(PyObject *dict) {
	...
	INSERT_INT_CONSTANT("NODE_STATE", HOOK_EVENT_NODE_STATE);
	...
	INSERT_INT_CONSTANT("NODE_STATE_FREE", INUSE_FREE);
	INSERT_INT_CONSTANT("NODE_STATE_OFFLINE", INUSE_OFFLINE);
	INSERT_INT_CONSTANT("NODE_STATE_DOWN", INUSE_DOWN);
	INSERT_INT_CONSTANT("NODE_STATE_DELETED", INUSE_DELETED);
	INSERT_INT_CONSTANT("NODE_STATE_UNRESOLVABLE", INUSE_UNRESOLVABLE);
	INSERT_INT_CONSTANT("NODE_STATE_JOB", INUSE_JOB);
	INSERT_INT_CONSTANT("NODE_STATE_STALE", INUSE_STALE);
	INSERT_INT_CONSTANT("NODE_STATE_JOBEXCL", INUSE_JOBEXCL);
	INSERT_INT_CONSTANT("NODE_STATE_BUSY", INUSE_BUSY);
	INSERT_INT_CONSTANT("NODE_STATE_UNKNOWN", INUSE_UNKNOWN);
	INSERT_INT_CONSTANT("NODE_STATE_NEEDS_HELLO_PING", INUSE_NEEDS_HELLO_PING);
	INSERT_INT_CONSTANT("NODE_STATE_INIT", INUSE_INIT);
	INSERT_INT_CONSTANT("NODE_STATE_PROV", INUSE_PROV);
	INSERT_INT_CONSTANT("NODE_STATE_WAIT_PROV", INUSE_WAIT_PROV);
	INSERT_INT_CONSTANT("NODE_STATE_RESVEXCL", INUSE_RESVEXCL);
	INSERT_INT_CONSTANT("NODE_STATE_OFFLINE_BY_MOM", INUSE_OFFLINE_BY_MOM);
	INSERT_INT_CONSTANT("NODE_STATE_MARKEDDOWN", INUSE_MARKEDDOWN);
	INSERT_INT_CONSTANT("NODE_STATE_NEED_ADDRS", INUSE_NEED_ADDRS);
	INSERT_INT_CONSTANT("NODE_STATE_MAINTENANCE", INUSE_MAINTENANCE);
	INSERT_INT_CONSTANT("NODE_STATE_SLEEP", INUSE_SLEEP);
	INSERT_INT_CONSTANT("NODE_STATE_NEED_CREDENTIALS", INUSE_NEED_CREDENTIALS);
	INSERT_INT_CONSTANT("NODE_STATE_VNODE_AVAILABLE", VNODE_AVAILABLE);
	INSERT_INT_CONSTANT("NODE_STATE_VNODE_UNAVAILABLE", VNODE_UNAVAILABLE);
