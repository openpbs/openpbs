 ...
 */
int
pbs_db_delete_attr_obj(pbs_db_conn_t *conn, pbs_db_obj_info_t *obj, void *obj_id, pbs_db_attr_list_t *db_attr_list) 
{
	return (db_fn_arr[obj->pbs_db_obj_type].pg_db_del_attr_obj(conn, obj_id, db_attr_list));
}
