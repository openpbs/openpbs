...
extern int action_sched_preempt_queue_prio(attribute *pattr, void *pobj, int actmode);
extern int action_sched_preempt_prio(attribute *pattr, void *pobj, int actmode);
extern int action_sched_preempt_order(attribute *pattr, void *pobj, int actmode);
extern int action_sched_preempt_sort(attribute *pattr, void *pobj, int actmode);
