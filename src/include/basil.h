...
#define BASIL_STRSET_SHORT(dst, src) \
		snprintf(dst, BASIL_STRING_SHORT, "%s", src)
#define BASIL_BZERO_SHORT(p) memset(p, 0, BASIL_STRING_SHORT)
#define BASIL_STRSET_MEDIUM(dst, src) \
		snprintf(dst, BASIL_STRING_MEDIUM, "%s", src)
#define BASIL_BZERO_MEDIUM(p) memset(p, 0, BASIL_STRING_MEDIUM)
#define BASIL_STRSET_LONG(dst, src) \
		snprintf(dst, BASIL_STRING_LONG, "%s", src)
#define BASIL_BZERO_LONG(p) memset(p, 0, BASIL_STRING_LONG)

/*
 * XML elements, attributes, and attribute values in BASIL.
 */
...
#define BASIL_ELM_RESVPARAMARRAY "ReserveParamArray"
/* BASIL_ELM_REQUEST */
#define BASIL_ELM_RESERVEPARAM	"ReserveParam"	/* BASIL_ELM_RESVPARAMARRAY */
#define BASIL_ELM_NODEPARMARRAY	"NodeParamArray"
/* BASIL_ELM_RESERVEPARAM */
#define BASIL_ELM_NODEPARAM	"NodeParam"	/* BASIL_ELM_NODEPARMARRAY */
#define BASIL_ELM_MEMPARAMARRAY	"MemoryParamArray"
/* BASIL_ELM_RESERVEPARAM */
#define BASIL_ELM_MEMPARAM	"MemoryParam"	/* BASIL_ELM_MEMPARAMARRAY */
#define BASIL_ELM_LABELPARAMARRAY "LabelParamArray"
/* BASIL_ELM_RESERVEPARAM */
...
#define BASIL_ELM_ACCELERATORALLOC "AcceleratorAllocation"
/* BASIL_ELM_ACCELERATOR */
#define BASIL_ELM_SEGMENTARRAY	"SegmentArray"	/* BASIL_ELM_NODE */
#define BASIL_ELM_SEGMENT	"Segment"	/* BASIL_ELM_SEGMENTARRAY */
#define BASIL_ELM_PROCESSORARRAY "ProcessorArray"
/* BASIL_ELM_SEGMENT */
#define BASIL_ELM_PROCESSOR	"Processor"	/* BASIL_ELM_PROCESSORARRAY */
#define BASIL_ELM_PROCESSORALLOC "ProcessorAllocation"
/* BASIL_ELM_PROCESSOR */
...
#define BASIL_ELM_RSVD_NODEARRAY	"ReservedNodeArray"
/* BASIL_ELM_RESERVED */
#define BASIL_ELM_RSVD_NODE		"ReservedNode"
/* BASIL_ELM_RSVD_NODEARRAY */
#define BASIL_ELM_RSVD_SGMTARRAY	"ReservedSegmentArray"
/* BASIL_ELM_RSVD_NODE */
#define BASIL_ELM_RSVD_SGMT		"ReservedSegment"
/* BASIL_ELM_RSVD_SGMTARRAY */
#define BASIL_ELM_RSVD_PROCARRAY	"ReservedProcessorArray"
/* BASIL_ELM_RSVD_SGMT */
#define BASIL_ELM_RSVD_PROCESSOR	"ReservedProcessor"
/* BASIL_ELM_RSVD_PROCARRAY */
#define BASIL_ELM_RSVD_MEMARRAY		"ReservedMemoryArray"
/* BASIL_ELM_RSVD_SGMT */
#define BASIL_ELM_RSVD_MEMORY		"ReservedMemory"
...
#define BASIL_ATR_RSVN_ID	"reservation_id"
/* BASIL_ELM_RESERVATION */
/* BASIL_ELM_REQUEST:confirm */
...
#define BASIL_ATR_WIDTH		"width"		/* BASIL_ELM_RESERVE */
/* BASIL_ELM_COMMAND */
#define BASIL_ATR_DEPTH		"depth"		/* BASIL_ELM_RESERVE */
/* BASIL_ELM_COMMAND */
#define BASIL_ATR_RSVN_MODE	"reservation_mode"
/* BASIL_ELM_RESERVE */
/* BASIL_ELM_RESERVATION */
#define BASIL_ATR_GPC_MODE	"gpc_mode"	/* BASIL_ELM_RESERVE */
/* BASIL_ELM_RESERVATION */
#define BASIL_ATR_OSCPN		"oscpn"		/* BASIL_ELM_RESERVE */
#define BASIL_ATR_NPPN		"nppn"		/* BASIL_ELM_RESERVE */
/* BASIL_ELM_COMMAND */
#define BASIL_ATR_NPPS		"npps"		/* BASIL_ELM_RESERVE */
#define BASIL_ATR_NSPN		"nspn"		/* BASIL_ELM_RESERVE */
#define BASIL_ATR_SEGMENTS	"segments"	/* BASIL_ELM_RESERVE */
...
/* BASIL_ELM_PROCESSOR */
/* BASIL_ELM_ACCELERATOR */
#define BASIL_ATR_CLOCK_MHZ	"clock_mhz"	/* BASIL_ELM_PROCESSOR */
/* BASIL_ELM_ACCELERATOR */
...
#define BASIL_ATR_APPLICATION_ID "application_id"
/* BASIL_ELM_APPLICATION */
...
#define BASIL_VAL_VERSION	BASIL_VAL_VERSION_1_2
...
/* BASIL supported versions array */
