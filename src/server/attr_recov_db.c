 ...
 */
int
encode_attr_db(struct attribute_def *padef, struct attribute *pattr, int numattr, pbs_db_attr_list_t *cache_attr_list, pbs_db_attr_list_t *db_attr_list, int all)
{
	int i;
 ...
 */
int
decode_attr_db(void *parent, pbs_db_attr_list_t *cache_attr_list, pbs_db_attr_list_t *db_attr_list, struct attribute_def *padef, struct attribute *pattr, int limit, int unknown)
{
	int index;
