...
/**
 * @brief
 * 		parse type expression associated to the definition of a new resource
 *
...
/**
 * @brief
 * 		parse flags expression associated to the definition of a new resource
 *
 * @param[in]	val	-	The value associated to the resource
...
/**
 * @brief
 * 		Verification of type and flag values
 *
 ...
 * @param[in]	path_rescdef	-	The path to the resource def file
