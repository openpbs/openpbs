...
class PbsAttributeDescriptor(object):
...
class PbsReadOnlyDescriptor(object):
    ...
    def __new__(cls,value):
        ...
        if isinstance(value, (str,)):
            ...
            if value == "Hot_Start":
                ...
                v = 0
        return super(server_state, cls).__new__(cls, v)
    ...
    def __new__(cls,value):
        ...
        if isinstance(value, (str,)):
            ...
            if (value == "Execution") or (value == "E"):
                ...
                # should not get here
                v = -1
        return super(queue_type, cls).__new__(cls, v)
    ...
    def __new__(cls,value):
        ...
        if isinstance(value, (str,)):
            ...
            if value == "T":
                ...
                # should not get here
                v = -1
        return super(job_state, cls).__new__(cls, v)
