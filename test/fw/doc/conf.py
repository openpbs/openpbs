...
latex_documents = [
  ('index', 'PbsTestLab.tex', u'PbsTestLab Documentation',
   u'Copyright (C) 1994-2016 Altair Engineering, Inc', 'manual'),
]
...
man_pages = [
    ('index', 'pbstestlab', u'PbsTestLab Documentation',
...
texinfo_documents = [
  ('index', 'PbsTestLab', u'PbsTestLab Documentation',
   ...
   'PbsTestLab', 'One line description of project.',
   'Miscellaneous'),
]
